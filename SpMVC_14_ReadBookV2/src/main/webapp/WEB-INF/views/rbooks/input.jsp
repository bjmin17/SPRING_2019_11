...
<link href="${rootPath}/css/rbook-main.css?version=2020-01-14-001" type="text/css" rel="stylesheet">
<link href="${rootPath}/css/main-table.css?version=2020-01-14-001" type="text/css" rel="stylesheet">
<link href="${rootPath}/css/color.css?version=2020-01-14-001" type="text/css" rel="stylesheet">
<script>
$(function(){
...
<section id="main-writer">
	<article>
		<form:form modelAttribute="rBookVO">
			<form:input type="text" path="rb_bcode" placeholder="도서 코드"/><br/>
