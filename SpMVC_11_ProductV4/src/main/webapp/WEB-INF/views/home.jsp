...
<body>
	...
	<nav class="container-fluid navbar navbar-expand-sm bg-dark">
		<ul class="navbar-nav">
			<li class="navbar-brand nav-link"><a class="nav-link" href="#">Home</a></li>
	...
	<section class="container-fluid">
		...
		<div id="p_list" class="col-lg-4 col-md-5 col-sm-11">
			...
			<div class="col-lg-4 col-md-5 col-sm-11">
				<form action="${rootPath}/input" class="was-validated" method="post" enctype="multipart/form-data">
					<div class="form-group">
						<label for="p_code">상품코드:</label> 
						
						<input type="text"
							class="form-control" placeholder="상품코드를 입력하세요"
							name="p_code"  id="p_code">
					</div>
					
					<div class="form-group">
						<label for="p_name">상품이름:</label> 
						<input type="text"
							class="form-control" placeholder="상품이름을 입력하세요"
					...
					<div class="form-group">
						...
						<input type="text"
							class="form-control" placeholder="매입가격을 입력하세요"
					...
					<div class="form-group">
						...
						<input type="text"
							class="form-control" placeholder="매출가격을 입력하세요"
					...
					<div class="form-group">
						<input 
								type="hidden" name="p_file" id="p_file">
						<label>대표이미지</label>
						<input type="file"
					...
					<div class="form-group container">
						<img src="${rootPath}/files/noimage.png" id="p_image" width="70%" >
	...
	<footer class="container-fluid bg-primary">
		<address class="text-center text-white">CopyRight &copy; bjmin17@naver.com</address>
	</footer>
</body>
</html>