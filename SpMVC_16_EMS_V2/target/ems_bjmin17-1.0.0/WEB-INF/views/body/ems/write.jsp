...
<fieldset class="email-write-box">
	<form:form modelAttribute="emailVO">
		...
		<div class="in-box">
			<label for="to_email">받는 Email</label><form:input path="to_email"/>
		</div>
		...
		<div class="in-box">
			<label for="to_name">받는 사람</label><form:input path="to_name"/>
		</div>
		
		<div class="in-box">
			<label for="subject">제목</label><form:input path="subject"/>
		</div>
		...
		<div class="in-box"><button>메일 보내기</button></div>
