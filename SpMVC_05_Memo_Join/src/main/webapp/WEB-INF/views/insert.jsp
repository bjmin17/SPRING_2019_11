...
/*
	...
	spring의 controller와 연동이 쉽게 하여주는 lib이다.
...
<fieldset>
	...
	<form:form modelAttribute="memoDTO" class="memo-form">
		...
		<%
		/* 표준 sqldmf 쓴다면 input 을 이렇게 추가하고 seq를 임의로 담아줘야한다. 그리고 보이지않도록 히든 추가*/
		/*<input name="m_seq" type="hidden" value='<c:out value="${memoDTO.m_seq}" default="d"/>*/
		%>
		<%
		/*
		html tag의 inputbox 와 달리
		name이라는 속성을 사용하지 않고 path라는 속성이 변수설정 역할을 수행한다.
		*/
		%>
