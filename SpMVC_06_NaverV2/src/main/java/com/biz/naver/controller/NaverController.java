...
public class NaverController {
	...
	public String news(String cat,String search,@RequestParam(value="currentPageNo",required = false, defaultValue = "1")long currentPageNo, Model model) {
		//@RequestParam(value="currentPageNo",required = false, defaultvalue="1"
		try {
