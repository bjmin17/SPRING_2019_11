...
*/
	header{
		...
		/*width : 50%;  화면크기의 50%, 브라우저 줄이면 자동으로 줄어듦 */
		margin:0;
		padding:1rem;
	}
	...
	*/
	nav a:hover{ /* nav 추가하면 아래 있는 네이버 홈페이지는 hover 액션에 해당 안된다.*/
		font-weight:bold; /* 마우스 올리면 글자가 두껍게 바뀜 , 글자모양을 bold체로 변경*/
		font-style:italic; /* 글자모양을 이텔릭체로 변경, 기울게 */
	}
	...
	/* 이 문서에 id가 p1으로 지정된 tag에 스타일을 지정하라 */
	/* p#p1 또는 #p1 형식으로 지정해도 된다 */
	p#p1{/*p #p1처럼 띄어쓰면 적용 안된다.*/
		font-size:50pt;
		background-color: blue;
		color:white;
	}
	
	/* 이 문서에 class가 pc로 지정된 tag에 스타일을 지정하라 */
...
<section>
	<article>
		...
		<p style="font-size:50pt;color=red;background:yellow"> 여기는 또다른 본문입니다</p>
		<p> 여기는 나의 이야기 입니다</p>
...
<footer>
	<address>CopyRight &copy; bjmin17@naver.com</address>
</footer>
</body>
</html>